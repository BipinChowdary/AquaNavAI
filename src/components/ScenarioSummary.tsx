...
export function ScenarioSummary({ scenario }: { scenario: LoadedScenario }) {
  ...
  return (
    <section className="panel scenario-summary" aria-labelledby="scenario-title">
      <div className="eyebrow">Pinned study domain</div>
      <h2 id="scenario-title">{manifest.title}</h2>
      <p className="panel-copy">
        A bounded FAU-relevant shelf experiment comparing identical missions under distance and
        forecast-aware energy objectives.
      </p>
